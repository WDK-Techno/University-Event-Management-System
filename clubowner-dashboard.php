                ...
                <div class="btn-group ms-auto me-0">
                    ...
                    <ul class="dropdown-menu shadow dropdown-menu-end">
                        ...
                        <li class="dropdown-item d-flex justify-content-start px-4"><span>Userboard</span>
                            <ion-icon name="arrow-undo-outline" class="ms-auto" style="font-size: 1.2rem;"></ion-icon>
                        </li>
                        <li class="dropdown-item d-flex justify-content-start px-4"><span>Profile</span>
                            <ion-icon name="person-outline" class="ms-auto" style="font-size: 1.2rem;"></ion-icon>
                        </li>
                        <li>
            ...
            foreach ($projects as $project) {
                ...
                <div class="col">
                    <div class="rounded border">
                        <div class="bg-image card d-block shadow-1-strong h-80"
                             style="background-image: url('https://assets-global.website-files.com/5e39e095596498a8b9624af1/5f6e93d250a6d04f4eae9f02_Backgrounds-WFU-thumbnail-(size).jpg');">
