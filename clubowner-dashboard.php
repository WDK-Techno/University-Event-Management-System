                                        ...
                                        <table class="table table-striped table tablesorter" id="ipi-table">
                                            <thead class="thead-dark">
                                                <tr>
                                                    ...
                                                    <th class="text-center">Star date</th>
                                                    <th class="text-center filter-false sorter-false">End Date</th>
                                                    <th class="text-center">Status</th>
                                                    <th class="text-center">Remove project</th>
                                                </tr>
                                            </thead>
