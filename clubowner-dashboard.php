    ...
    <div id="menu-content-4" class="main-content hide">
        ...
        <div class="ml-1    row-cols-1 row-cols-md-3 row-cols-xl-4 ">
            ...
            <div class="card" style="width: 18rem">
                ...
                <img class="card-img-top" src="assets/images/flyer_img/<?= $publicFlyerObj->getFlyerImg() ?>"
                     alt="Card image cap"/>
                <!----------------- card  body ------------------->
                <div class="card-body">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="process/clubownerdashboard/editFlyer.php"
                                                ...
                                                <div class="col-6">
                                                    <div class="upload">
                                                        <img src="assets/images/flyer_img/<?= $publicFlyerObj->getFlyerImg() ?>"
                                                             id="image">
                                                        <input type="hidden" name="flyerUpdateImg2" id="fileImg2"
                                                               value="<?= $publicFlyerObj->getFlyerImg() ?>">

                                                        <div class="rightRound" id="upload">
                                                            <input type="file" name="flyerUpdateImg" id="fileImg"
                                                                   accept=".jpg, .jpeg, .png">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="submit" class="btn" onclick="validateForm()"
