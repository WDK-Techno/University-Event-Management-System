...
--
-- Host: localhost
-- Generation Time: Oct 27, 2023 at 08:49 PM
...
INSERT INTO `main_task` (`main_task_id`, `main_task_name`, `start_date`, `end_date`, `project_id`, `status`) VALUES
(1, 'Initial Tasks', '2023-08-31', '2023-09-05', 1, 'active'),
(2, 'Initial Tasks', '2023-09-05', '2023-09-20', 5, 'active');
...
(1, 'JamborIEEE23', 11, 4, 'active', '2023-08-21', '2023-10-28', 'JamborIEEE is a project intiate by IEEE Sri Lanka Section. ', '64e830b42afda8.67288644.png'),
...
(1, 'create Logo', NULL, '2023-09-02 19:24:07', 4, 0, 1, 'active'),
(2, 'Set Location', NULL, '2023-09-03 19:27:40', 4, 0, 1, 'active'),
(3, 'OC Member Add', NULL, '2023-09-07 02:48:08', 4, 0, 2, 'active');
...
ALTER TABLE `sub_task`
  ...
  ADD KEY `asign_member_id` (`asign_member_id`),
...
--
ALTER TABLE `main_task`
  MODIFY `main_task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `main_task`
  ADD CONSTRAINT `main_task_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`);
...
--
ALTER TABLE `sub_task`
  ADD CONSTRAINT `sub_task_ibfk_1` FOREIGN KEY (`asign_member_id`) REFERENCES `undergraduate` (`user_id`),
  ADD CONSTRAINT `sub_task_ibfk_2` FOREIGN KEY (`main_task_id`) REFERENCES `main_task` (`main_task_id`);
