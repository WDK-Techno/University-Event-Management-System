...
--
-- Host: localhost
-- Generation Time: Aug 21, 2023 at 05:26 AM
...
CREATE TABLE `club` (
  ...
  `profile_image` varchar(30) NOT NULL DEFAULT 'club_profile_default.jpg'
...
CREATE TABLE `project` (
  ...
  `profile_image` varchar(30) NOT NULL DEFAULT 'project_profile_default.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `project` (`project_id`, `name`, `club_id`, `project_chair_id`, `status`, `start_date`, `profile_image`) VALUES
(1, 'JamborIEEE23', 11, 4, 'active', '2023-08-21', 'project_profile_default.jpg');
...
CREATE TABLE `undergraduate` (
  ...
  `profile_image` varchar(30) NOT NULL DEFAULT 'ug_profile_default.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
