...
<!--========== main content =========-->
<div class="main" style="padding: 10px; margin-top: 10px">
    <div id="dp"></div>
</div>
...
<script>
    ...
    dp.onRowMove = async (args) => {
        ...
        await DayPilot.Http.post("GrantChart/gantt_row_move.php", data);
        // dp.message("Updated");
    ...
    dp.onTaskClick = async (args) => {
        ...
        await DayPilot.Http.post("GrantChart/gantt_task_update.php", postData);
        dp.tasks.update(args.task);
    ...
    function loadTasks() {
        dp.tasks.load("GrantChart/gantt_tasks.php");
    }
        ...
        items: [
            {
                ...
                onClick: async (args) => {
                    const id = args.source.id();
                    await DayPilot.Http.post("GrantChart/gantt_task_delete.php", {id});
                    loadTasks();
                }
            }
        ]
...
<!-- ==== include java script file name grantchart.js ====-->
